...
enum sm5720_charger_reg {
    ...
    SM5720_CHG_REG_BLEDCURRENT      = 0x1F,
    SM5720_CHG_REG_RLEDCURRENT      = 0x20,
    SM5720_CHG_REG_GLEDCURRENT      = 0x21,
    SM5720_CHG_REG_WLEDCURRENT      = 0x22,
    SM5720_CHG_REG_DIMSLPBLEDCNTL   = 0x23,
    SM5720_CHG_REG_DIMSLPRLEDCNTL   = 0x24,
    SM5720_CHG_REG_DIMSLPGLEDCNTL   = 0x25,
    SM5720_CHG_REG_DIMSLPWLEDCNTL   = 0x26,
    SM5720_CHG_REG_BLEDCNTL1        = 0x27,
    SM5720_CHG_REG_BLEDCNTL2        = 0x28,
    SM5720_CHG_REG_BLEDCNTL3        = 0x29,
    SM5720_CHG_REG_BLEDCNTL4        = 0x2A,
    SM5720_CHG_REG_RLEDCNTL1        = 0x2B,
    SM5720_CHG_REG_RLEDCNTL2        = 0x2C,
    SM5720_CHG_REG_RLEDCNTL3        = 0x2D,
    SM5720_CHG_REG_RLEDCNTL4        = 0x2E,
    SM5720_CHG_REG_GLEDCNTL1        = 0x2F,
    SM5720_CHG_REG_GLEDCNTL2        = 0x30,
    SM5720_CHG_REG_GLEDCNTL3        = 0x31,
    SM5720_CHG_REG_GLEDCNTL4        = 0x32,
...
enum sm5720_irq {
    /* MUIC INT1 */
    SM5720_MUIC_IRQ_INT1_LKR,              /* 0  */
    SM5720_MUIC_IRQ_INT1_LKP,              /* 1  */
    SM5720_MUIC_IRQ_INT1_KP,               /* 2  */
    SM5720_MUIC_IRQ_INT1_DETACH,           /* 3  */
    SM5720_MUIC_IRQ_INT1_ATTACH,           /* 4  */

    /* MUIC INT2 */
    SM5720_MUIC_IRQ_INT2_VBUSDET_ON,       /* 5  */
    SM5720_MUIC_IRQ_INT2_RID_CHARGER,      /* 6  */
    SM5720_MUIC_IRQ_INT2_MHL,              /* 7  */
    SM5720_MUIC_IRQ_INT2_STUCK_KEY_RCV,    /* 8  */
    SM5720_MUIC_IRQ_INT2_STUCK_KEY,        /* 9  */
    SM5720_MUIC_IRQ_INT2_ADC_CHG,          /* 10 */
    SM5720_MUIC_IRQ_INT2_REV_ACCE,         /* 11 */
    SM5720_MUIC_IRQ_INT2_VBUS_OFF,         /* 12 */

    /* MUIC INT3-AFC */
    SM5720_MUIC_IRQ_INT3_QC20_ACCEPTED,    /* 13 */
    SM5720_MUIC_IRQ_INT3_AFC_ERROR,        /* 14 */
    SM5720_MUIC_IRQ_INT3_AFC_STA_CHG,      /* 15 */
    SM5720_MUIC_IRQ_INT3_MULTI_BYTE,       /* 16 */
    SM5720_MUIC_IRQ_INT3_VBUS_UPDATE,      /* 17 */
    SM5720_MUIC_IRQ_INT3_AFC_ACCEPTED,     /* 18 */
    SM5720_MUIC_IRQ_INT3_AFC_TA_ATTACHED,  /* 19 */
    ...
    /* CHG INT3 */
    SM5720_CHG_IRQ_INT3_THEMREG,
    SM5720_CHG_IRQ_INT3_THEMSHDN,
    ...
    /* CHG INT4 */
    SM5720_CHG_IRQ_INT4_BOOSTPOK_NG,
    SM5720_CHG_IRQ_INT4_BOOSTPOK,
    SM5720_CHG_IRQ_INT4_THEM_H,
    SM5720_CHG_IRQ_INT4_THEM_C,
    SM5720_CHG_IRQ_INT4_nVBUSOK,
    SM5720_CHG_IRQ_INT4_nWPCOK,
    SM5720_CHG_IRQ_INT4_MRSTB,
    SM5720_CHG_IRQ_INT4_WPCIN_UPDATE,

    /* FG INT */
    SM5720_FG_IRQ_INT_LOW_VOLTAGE,
    SM5720_FG_IRQ_INT_LOW_TEMP,
    SM5720_FG_IRQ_INT_HIGH_TEMP,
