...
static void sm5720_haptic_shutdown(struct device *dev)
{
	struct sm5720_haptic_data *haptic = dev_get_drvdata(dev);
...
static int sm5720_haptic_resume(struct platform_device *pdev)
{
    ...
    sm5720_set_haptic_VDD(haptic, HAPTIC_VDD_External);
    sm5720_set_haptic_motor_sel(haptic, HAPTIC_MOTOR_LRA);
