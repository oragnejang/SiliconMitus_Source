...
#ifndef __SM5424_CHARGER_H__
#define __SM5424_CHARGER_H__

#define SM5424_TOPOFF_TIMER_SUPPORT
...
/**********************************************************
  ...
  *
  *********************************************************/
extern int sm5424_chg_enable(int en);
extern void sm5424_otg_enable(unsigned int enable);
extern unsigned int sm5424_get_status1(void);
extern unsigned int sm5424_get_status2(void);
extern unsigned int sm5424_get_status3(void);
extern unsigned int sm5424_get_status4(void);
extern void sm5424_set_nENZCS(unsigned int val);
extern void sm5424_set_ENI2CRESET(unsigned int val);
extern void sm5424_set_SUSPEND(unsigned int val);
extern void sm5424_set_RESET(unsigned int val);
extern void sm5424_set_ENBOOST(unsigned int val);
extern void sm5424_set_AUTOSTOP(unsigned int val);
extern void sm5424_set_CHGEN(unsigned int val);
extern void sm5424_set_VBUSLIMIT(unsigned int val);
extern void sm5424_set_AICLTH(unsigned int val);
extern void sm5424_set_AICLEN(unsigned int val);
extern void sm5424_set_DISLIMIT(unsigned int val);
extern void sm5424_set_PRECHG(unsigned int val);
extern void sm5424_set_FASTCHG(unsigned int val);
extern void sm5424_set_BATREG(unsigned int val);
extern void sm5424_set_Q2LIM(unsigned int val);
extern void sm5424_set_FREQSEL(unsigned int val);
extern void sm5424_set_TOPOFF(unsigned int val);
extern void sm5424_set_TOPOFFTIMER(unsigned int val);
extern void sm5424_set_FASTTIMER(unsigned int val);
extern void sm5424_set_OTGCURRENT(unsigned int val);
extern void sm5424_set_BST_IQ3LIMIT(unsigned int val);
extern void sm5424_set_VOTG(unsigned int val);
extern unsigned int sm5424_get_REVISIONID(void);

extern void sm5424_dump_register(void);

extern unsigned int sm5424_read_interface(unsigned char RegNum, unsigned char *val, unsigned char MASK, unsigned char SHIFT);
extern unsigned int sm5424_config_interface(unsigned char RegNum, unsigned char val, unsigned char MASK, unsigned char SHIFT);
extern unsigned int sm5424_reg_config_interface(unsigned char RegNum, unsigned char val);

#endif /* __SM5424_CHARGER_H__ */
