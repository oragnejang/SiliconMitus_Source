...
/**********************************************************
  ...
  *
  *********************************************************/
extern void sm5424_otg_enable(kal_uint32 enable);
extern kal_uint32 sm5424_get_status1(void);
extern kal_uint32 sm5424_get_status2(void);
extern kal_uint32 sm5424_get_status3(void);
extern kal_uint32 sm5424_get_status4(void);
extern void sm5424_set_nENZCS(kal_uint32 val);
extern void sm5424_set_ENI2CRESET(kal_uint32 val);
extern void sm5424_set_SUSPEND(kal_uint32 val);
extern void sm5424_set_RESET(kal_uint32 val);
extern void sm5424_set_ENBOOST(kal_uint32 val);
extern void sm5424_set_AUTOSTOP(kal_uint32 val);
extern void sm5424_set_CHGEN(kal_uint32 val);
extern void sm5424_set_VBUSLIMIT(kal_uint32 val);
extern void sm5424_set_AICLTH(kal_uint32 val);
extern void sm5424_set_AICLEN(kal_uint32 val);
extern void sm5424_set_DISLIMIT(kal_uint32 val);
extern void sm5424_set_PRECHG(kal_uint32 val);
extern void sm5424_set_FASTCHG(kal_uint32 val);
extern void sm5424_set_BATREG(kal_uint32 val);
extern void sm5424_set_Q2LIM(kal_uint32 val);
extern void sm5424_set_FREQSEL(kal_uint32 val);
extern void sm5424_set_TOPOFF(kal_uint32 val);
extern void sm5424_set_TOPOFFTIMER(kal_uint32 val);
extern void sm5424_set_FASTTIMER(kal_uint32 val);
extern void sm5424_set_OTGCURRENT(kal_uint32 val);
extern void sm5424_set_BST_IQ3LIMIT(kal_uint32 val);
extern void sm5424_set_VOTG(kal_uint32 val);
extern kal_uint32 sm5424_get_REVISIONID(void);
