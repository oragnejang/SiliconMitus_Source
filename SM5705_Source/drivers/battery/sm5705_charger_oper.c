...
enum {
    OP_MODE_SUSPEND             = 0x0,
    OP_MODE_FACTORY             = 0x1,
    OP_MODE_WPC_OTG_CHG_OFF     = 0x2,
    OP_MODE_WPC_OTG_CHG_ON      = 0x3,
    OP_MODE_CHG_OFF             = 0x4,
    OP_MODE_CHG_ON              = 0x5,
    OP_MODE_FLASH_BOOST         = 0x6,
    OP_MODE_USB_OTG             = 0x7,
};
...
static struct sm5705_charger_oper_table_info sm5705_charger_operation_mode_table[] = {
    ...
    { make_OP_STATUS(0,0,0,0,0,0), OP_MODE_CHG_ON, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(1,0,0,0,0,0), OP_MODE_CHG_ON, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(1,1,0,0,0,0), OP_MODE_CHG_ON, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(1,0,0,1,0,0), OP_MODE_CHG_ON, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(1,1,0,1,0,0), OP_MODE_CHG_ON, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(0,1,0,0,0,0), OP_MODE_CHG_ON, BST_OUT_4500mV, OTG_CURRENT_500mA},
    /* Charger mode : Flash Boost */
    { make_OP_STATUS(0,0,1,0,0,0), OP_MODE_FLASH_BOOST, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(0,0,1,0,1,0), OP_MODE_FLASH_BOOST, BST_OUT_4500mV, OTG_CURRENT_900mA},
    { make_OP_STATUS(0,0,1,0,0,1), OP_MODE_FLASH_BOOST, BST_OUT_4500mV, OTG_CURRENT_900mA},
    { make_OP_STATUS(0,1,1,0,0,0), OP_MODE_FLASH_BOOST, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(0,1,1,0,1,0), OP_MODE_FLASH_BOOST, BST_OUT_4500mV, OTG_CURRENT_900mA},
    { make_OP_STATUS(0,1,1,0,0,1), OP_MODE_FLASH_BOOST, BST_OUT_4500mV, OTG_CURRENT_900mA},
    { make_OP_STATUS(1,0,1,0,0,0), OP_MODE_FLASH_BOOST, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(1,1,1,0,0,0), OP_MODE_FLASH_BOOST, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(0,0,0,1,0,0), OP_MODE_FLASH_BOOST, BST_OUT_4500mV, OTG_CURRENT_500mA},
    /* Charger mode : Wireless OTG & Charger ON */
    { make_OP_STATUS(0,1,0,1,1,0), OP_MODE_WPC_OTG_CHG_ON, BST_OUT_5000mV, OTG_CURRENT_900mA},
    { make_OP_STATUS(0,1,0,1,0,1), OP_MODE_WPC_OTG_CHG_ON, BST_OUT_5000mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(0,1,0,1,0,0), OP_MODE_WPC_OTG_CHG_ON, BST_OUT_4500mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(0,1,0,0,1,0), OP_MODE_WPC_OTG_CHG_ON, BST_OUT_5000mV, OTG_CURRENT_900mA},
    { make_OP_STATUS(0,1,0,0,0,1), OP_MODE_WPC_OTG_CHG_ON, BST_OUT_5000mV, OTG_CURRENT_500mA},
    /* Charger mode : USB OTG */
    { make_OP_STATUS(0,0,0,1,1,0), OP_MODE_USB_OTG, BST_OUT_5000mV, OTG_CURRENT_900mA},
    { make_OP_STATUS(0,0,0,1,0,1), OP_MODE_USB_OTG, BST_OUT_5000mV, OTG_CURRENT_500mA},
    { make_OP_STATUS(0,0,0,0,1,0), OP_MODE_USB_OTG, BST_OUT_5000mV, OTG_CURRENT_900mA},
    { make_OP_STATUS(0,0,0,0,0,1), OP_MODE_USB_OTG, BST_OUT_5000mV, OTG_CURRENT_500mA},
};
...
{
    return sm5705_update_reg(i2c, SM5705_REG_CHGCNTL6, OTG_CURRENT, SM5705_OTGCURRENT_MASK);
}
...
int sm5705_charger_oper_table_init(struct i2c_client *i2c)
{
    ...
    oper_info.current_table.oper_mode = OP_MODE_CHG_ON;
