...
enum sm5713_irq {
    /* MUIC INT1 */
    SM5713_MUIC_IRQ_INT1_DPDM_OVP,          /* 00 */
...
enum {
    ...
    SM5713_CHARGER_OP_EVENT_PWR_SHAR    = 0x4,
    SM5713_CHARGER_OP_EVENT_USB_OTG     = 0x3,
    SM5713_CHARGER_OP_EVENT_FLASH       = 0x2,
    SM5713_CHARGER_OP_EVENT_TORCH       = 0x1,
    SM5713_CHARGER_OP_EVENT_SUSPEND     = 0x0,
};

extern int sm5713_charger_oper_table_init(struct i2c_client *i2c);
