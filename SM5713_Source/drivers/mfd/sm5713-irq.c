...
static irqreturn_t sm5713_irq_thread(int irq, void *data)
{
    ...
    if (irq_src == 0) {
        if (sm5713->check_muic_reset) {sm5713->check_muic_reset(sm5713->muic, sm5713->muic_data); }
        if (sm5713->check_chg_reset) { sm5713->check_chg_reset(sm5713->charger, sm5713->chg_data); }
        if (sm5713->check_fg_reset) { sm5713->check_fg_reset(sm5713->fuelgauge, sm5713->fg_data); }
    }
