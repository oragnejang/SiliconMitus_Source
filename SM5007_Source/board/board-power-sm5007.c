...
/*control by slpt floader sleep bin*/
#if 0
...
SM_PDATA_INIT(buck1_dvs, 0,	700,   1300, 0, BUCK1_ALWAYS_ON, BUCK1_BOOT_ON, 1,
		 BUCK1_INIT_UV, BUCK1_INIT_ENABLE, 1, 0, 0, 0, BUCK1_LPM);
#endif
SM_PDATA_INIT(buck2, 0,	1200,   1200, 0, BUCK2_ALWAYS_ON, BUCK2_BOOT_ON, 1,
		 BUCK2_INIT_UV, 1, BUCK2_INIT_ENABLE, 0, 0, 0, BUCK2_LPM);

SM_PDATA_INIT(buck3, 0,	1800,   1800, 0, BUCK3_ALWAYS_ON, BUCK3_BOOT_ON, 1,
...
SM_PDATA_INIT(ldo3, 0,	3000,   3000, 0, LDO3_ALWAYS_ON, LDO3_BOOT_ON, 1,
		 LDO3_INIT_UV, LDO3_INIT_ENABLE, 1, 0, 0, 0, LDO3_LPM);

SM_PDATA_INIT(ldo4, 0,	3000,   3000, 0, LDO4_ALWAYS_ON, LDO4_BOOT_ON, 1,
		 LDO4_INIT_UV, LDO4_INIT_ENABLE, 1, 0, 0, 0, LDO4_LPM);

SM_PDATA_INIT(ldo5, 0,	2500,   2500, 0, LDO5_ALWAYS_ON, LDO5_BOOT_ON, 1,
...
SM_PDATA_INIT(ps3, 0,   1800,   1800, 0, PS3_ALWAYS_ON, PS3_BOOT_ON, 1,
		 PS3_INIT_UV, PS3_INIT_ENABLE, 1, 0, 0, 0, PS3_LPM);
SM_PDATA_INIT(ps4, 0,	3000,   3000, 0, PS4_ALWAYS_ON, PS4_BOOT_ON, 1,
		 PS4_INIT_UV, PS4_INIT_ENABLE, 1, 0, 0, 0, PS4_LPM);
SM_PDATA_INIT(ps5, 0,	3000,   3000, 0, PS5_ALWAYS_ON, PS5_BOOT_ON, 1,
...
static struct sm5007_fuelgauge_platform_data sm5007_fuelgauge_data = {
	...
	.alarm_vol_mv 	= 3200, /* the voltage(mV) to report soc 0%, for battery safe, 0mV means disable */
	...
	.type[0] = {
        ...
        .charge_offset_cal = 0x05,/*change 0x10-->0x05*/
        ...
        .rs_value[3] = 0x00a4,
        .vit_period = 0x3506,
        .mix_value[0] = 0x0403,		/*mix_rate init_blank*/
        .mix_value[1] = 0x0004,
	...
	/*the battery for 295mAh*/
    .type[2] = {
        .id = 0,
        .battery_type = 4350,                       /* 4.33350V */
        //.battery_table = battery_data_table0,
        .temp_std = 20,
        .temp_offset = 10,
        .temp_offset_cal = 0x1E,// 0x25,
        .temp_offset_cal_ofs = 0x02,
        .charge_offset_cal = 0x16,//0x11,//0x16,//0x05,
        .rce_value[0] = 0x0749,
        .rce_value[1] = 0x0580,
        .rce_value[2] = 0x371,
        .dtcd_value = 0x1,
        .rs_value[0] = 0x35c,		/*rs mix_factor max min*/
        .rs_value[1] = 0x47a,
        .rs_value[2] = 0x3800,
        .rs_value[3] = 0x00a4,
        .vit_period = 0x3506,
        ...
        .topoff_soc[1] = 0x000,		/*topoff_soc threadhold*/
        .volt_cal = 0x8000,
        .curr_cal = 0x8F00,//0x9900,//0x8F00,
    },
	/*the battery for 300mAh*/
    .type[3] = {
        .id = 0,
        .battery_type = 4350,                       /* 4.33350V */
        //.battery_table = battery_data_table0,
        .temp_std = 20,
        .temp_offset = 10,
        .temp_offset_cal = 0x1E,
        .temp_offset_cal_ofs = 0x02,
        .charge_offset_cal = 0x0e,
        .rce_value[0] = 0x0749,
        .rce_value[1] = 0x0580,
        .rce_value[2] = 0x371,
        .dtcd_value = 0x1,
...
static struct sm5007_charger_platform_data sm5007_charger_data = {
	...
	.type = {
		...
		.chg_batreg 	= 4200, /* mV */
#elif defined(CONFIG_295MAH_BATTERY) || defined(CONFIG_300MAH_BATTERY) || defined(CONFIG_400MAH_BATTERY)
		.chg_batreg     = 4350,
#else
		.chg_batreg     = 4350,
#endif
#if defined(CONFIG_295MAH_BATTERY) || defined(CONFIG_300MAH_BATTERY) || defined(CONFIG_400MAH_BATTERY)
		.chg_fastchg    = 140,  // 20mA/step
#else
		.chg_fastchg    = 300,  /* mA */
#endif
