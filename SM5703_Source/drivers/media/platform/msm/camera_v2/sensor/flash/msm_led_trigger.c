	...
	void *data)
{
	...
	case MSM_CAMERA_LED_OFF:
		...
		if (fled_info) {
            ...
            flashlight_flash(fled_info->flashlight_dev, TURN_WAY_GPIO);
...
//		if (lock_state) {
//			if (fled_info) {
//				sm5703_fled_flash_critial_section_unlock(fled_info);
//				lock_state = false;
//			}
//		}
#endif
	...
	case MSM_CAMERA_LED_LOW:
		...
		//gpio_free(fctrl->led_irq_gpio1);
		if (fled_info) {
    		flashlight_set_mode(fled_info->flashlight_dev, FLASHLIGHT_MODE_MOVIE);
            sm5703_fled_notification(fled_info);
    		flashlight_flash(fled_info->flashlight_dev, TURN_WAY_GPIO);
        }
		break;
...
//		}
//		if (fled_info) {
//			sm5703_fled_flash_critial_section_lock(fled_info);
//			lock_state = true;
//		}
#endif
		//gpio_request(fctrl->led_irq_gpio2, NULL);
